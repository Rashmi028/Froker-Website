  ...
  return (
    <section className='Footer-section'>
      <div className='Footer-columns'>
        ...
        <div class="scan-to-download1">
            <h4>Scan To Download</h4>
        </div>
        <img src="https://res.cloudinary.com/dapbrn8a9/image/upload/q_auto:low/v1706009706/Frokerassets/froker-1-3-10_pb9yln.jpg" class="qr" alt="QR Code"></img>
        </div>
      </div>
      <div className="des">
            <div className="position-relative">
                <img src="/waves2.svg" className="footersvg" alt="Footer SVG"/>
        ...
        <div className="desa">
            <div className="position-relativem">
                <img src="/waves1.svg" className="footersvgm" alt="Footer SVG"/>
